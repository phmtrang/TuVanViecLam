...
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS17', 'Kinh tế chính trị');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS18', 'Chính trị học');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS19', 'Thiết kế thời trang');
...
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS22', 'Hải quân');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS23', 'Địa chất học');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS24', 'Địa lý học');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS25', 'Hải dương học');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS26', 'Thực vật học');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS27', 'Sinh vật học');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS28', 'Sinh thái học');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS29', 'Động vật học');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS30', 'Khí tượng thủy văn');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS31', 'Diễn viên múa');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS32', 'Diễn viên sân khấu kịch hát');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS33', 'Điêu khắc');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS34', 'Gốm');
INSERT INTO `httt`.`chuyennganh` (`id`, `chuyenNganh`) VALUES ('soS35', 'Hội họa');
